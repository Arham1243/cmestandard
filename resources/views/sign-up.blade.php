                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="inputField">
                                        ...
                                        <input value="{{ old('phone') }}" type="text" placeholder=""
                                            name="phone" required>
                                ...
                                <div class="col-lg-6">
                                    <div class="inputField">
                                        <label class="title">Select Speciality Area <span class="text-danger">*</span>:</label>
                                ...
                                <div class="col-lg-6">
                                    <div class="inputField">
                                        <label class="title">Select Speciality Interest <span class="text-danger">*</span>:</label>
                                ...
                                <div class="col-lg-12">
                                    <div class="inputField">
                                        ...
                                        <input value="{{ old('medical_license_number') }}" type="text" placeholder="" name="medical_license_number" required>
                                ...
                                <div class="col-lg-6">
                                    <div class="inputField">
                                        <label class="title">Institution Name <span class="text-danger">*</span>:</label>
                                ...
                                <div class="col-lg-6">
                                    <div class="inputField">
                                        <label class="title">Institution City <span class="text-danger">*</span>:</label>
                                ...
                                <div class="col-lg-12">
                                    <div class="placeholder-user">
                                        <label class="placeholder-user__img" for="profile-img">
                                            <img src="{{ asset('assets/images/user.png') }}" alt="image" class="imgFluid profile-img" loading="lazy">
                                        </label>
                                        <input type="file" name="profile_img" id="profile-img" onchange="thumb(this);" class="d-none">
