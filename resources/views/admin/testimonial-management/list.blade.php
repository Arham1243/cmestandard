            ...
            <table id="user-table" class="table table-bordered" style="width:100%">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <img src="{{ asset($testimonial->img_path) }}" alt='image' class='imgFluid list-img list-img--circle' loading='lazy'>
                  </td>
               
                
                  <!-- <td>{{-- date('d-M-Y,strtotime($testimonial->created_at)) --}}</td> -->
                
                  {{-- <td>{{ $testimonial->is_featured == '1' ? 'Featured' : 'Not featured' }}</td> --}}
                    ...
                    <div class="dropdown show action-dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="action-dropdown">
                        ...
                        <a class="dropdown-item" href="{{route('admin.edit_testimonial',$testimonial->id)}}"><i class="fa fa-pencil-square-o"
                            aria-hidden="true"></i>
                          Edit</a>
                          <a class="dropdown-item" onclick="return confirm('Are you sure you want to delete this Testimonial')" href="{{route('admin.delete_testimonial',$testimonial->id)}}"><i class="fa fa-pencil-square-o"
                            aria-hidden="true"></i>
                          Delete</a>
