                    ...
                    <div class="row align-items-center mc-b-3">
                        <div class="col-lg-6 col-12">
                            <div class="primary-heading color-dark">
                                <h2>Blogs Category Management</h2>
                            </div>
                        </div>
                        <div class="col-lg-6 col-12">
                            <div class="text-right">
                                <a href="{{ route('admin.add_blog_category') }}" class="primary-btn primary-bg">Add New</a>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="dropdown show action-dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="action-dropdown">
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{ route('admin.edit_blog_category', $value->id) }}"><i
                                                            class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                        Edit</a>
                                                    <a class="dropdown-item" onclick="return confirm('Are You sure to delete This?')"
                                                        href="{{ route('admin.delete_blog_category', $value->id) }}"><i
                                                            class="fa fa-trash-o" aria-hidden="true"></i>
                                                        Delete</a>
                                                    @if ($value->is_active == 1)
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.suspend_blog_category', $value->id) }}"><i
