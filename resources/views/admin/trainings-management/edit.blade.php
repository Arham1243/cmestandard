                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-6 col-md-12 col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="designation" required class="form-control" value="{{ $testimonial->designation }}">
                        ...
                        {{-- <div class="col-lg-12 col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <div class="input-field--check">
                                    <input type="checkbox" name="is_featured" id="is_featured" {{ $testimonial->is_featured == '1' ? 'checked' : '' }} >
