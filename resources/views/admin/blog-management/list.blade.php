          ...
          <div class="table-responsive">
            <table id="user-table" class="table table-bordered" style="width:100%">
              ...
              <tbody>
                ...
                <tr>
                  <td>{{$i}}</td>
                  <td>{{$blog->get_categories->title}}</td>
                  <td>{{$blog->title}}</td>
                  <td><img class="list-img" src="{{asset($blog->img_path)}}"></td>
                    ...
                    <div class="dropdown show action-dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="action-dropdown">
                        ...
                        <a class="dropdown-item" href="{{route('admin.edit_blog',$blog->id)}}"><i class="fa fa-pencil-square-o"
                            aria-hidden="true"></i>
                          Edit</a>
                          <a class="dropdown-item" onclick="return confirm('Are you sure you want to delete this Blog?')" href="{{route('admin.delete_blog',$blog->id)}}"><i class="fa fa-pencil-square-o"
                            aria-hidden="true"></i>
                          Delete</a>
                          @if($blog->is_active == 1)
