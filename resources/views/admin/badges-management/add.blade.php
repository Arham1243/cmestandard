    ...
    <div class="main-sec">
        <div class="main-wrapper">
            ...
            <div class="user-wrapper">
                <form id="add-record-form" action="{{ route('admin.save_badges_management') }}" enctype="multipart/form-data"
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-6 col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <input type="number" name="min_credit_hours" required class="form-control">
                        ...
                        <div class="col-lg-6 col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <input type="number" name="max_credit_hours" class="form-control">
