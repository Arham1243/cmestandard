                    ...
                    <div class="row align-items-center mc-b-3 resp-pb">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="text-right">
                                <a href="{{ route('admin.add_profile') }}" class="primary-btn primary-bg">Add New</a>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="dropdown show action-dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="action-dropdown">
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{ route('admin.edit_profile', $profile->id) }}"><i
                                                            class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                        Edit</a>
                                                    <a class="dropdown-item"
                                                        href="{{ route('admin.delete_profile', $profile->id) }}"><i
                                                            class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                        Delete</a>
                                                    @if ($profile->is_active == 1)
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.suspend_profile', $profile->id) }}"><i
