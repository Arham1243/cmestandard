                ...
                <div class="user-wrapper">
                    <div class="row align-items-center mc-b-3 resp-pb">
                        <div class="col-lg-6 col-12">
                            <div class="primary-heading color-dark">
                                <h2>Welcome Banner Management</h2>
                            </div>
                        </div>
                      {{--  <div class="col-lg-6 col-12">
                            <div class="text-right">
                                <a href="{{ route('admin.addwelcomeSlider') }}" class="primary-btn primary-bg">Add New</a>
                            </div>
                        </div> --}}
                    </div>
                    ...
                    <div class="table-responsive">
                        <table id="user-table" class="table table-bordered" style="width:100%">
                            ...
                            <tbody>
                                <?php $i = 1; ?>
                                @foreach ($welcome_slider as $new)
                                    <tr>
                                        <td>{{ $i }}</td>
                                        <td>{{ $new->headings }}</td>
                                        <td>{{ $new->subHeading }}</td>
                                        <td>{{ $new->long_desc }}</td>
