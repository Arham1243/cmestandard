...
<head>
    ...
    <meta name="description" content="Training Update Notification">
    <style>
        a:hover {
                                ...
                                <tr>
                                    <td style="padding:0 15px; text-align:left;">
                                        ...
                                        <p
                                            ...
                                            The training titled <strong>{{ $training->title }}</strong> for
                                            {{ $user->full_name }} has been updated and is pending endorser approval.
                                        </p>
                                    </td>
                                </tr>
                                <!-- Details Table -->
